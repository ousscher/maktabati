                ...
                <div className={`transition-all duration-500 ${showChat ? "w-2/3" : "w-full"}`}>
                    ...
                    <div className="flex justify-between items-center py-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <Image src="/images/icons/chevron-down.svg" alt="Dropdown" width={12} height={12} />
                            <h1 className="text-2xl font-semibold">{folderName || t("myFiles")}</h1>
                            <Image src="/images/icons/chevron-down.svg" alt="Dropdown" width={12} height={12} />
                        </div>
                            ...
                            {isFirstModalOpen && (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <span className="text-sm">{t("downloadThisFolder")}</span>
                                    </button>
                                    ...
                                    >
                                        ...
                                        <span className="text-sm">{t("deleteThisFolder")}</span>
                                    </button>
