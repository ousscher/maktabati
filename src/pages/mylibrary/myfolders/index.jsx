...
export default function MyFolders() {
  ...
  const uploadFile = async () => {
    ...
    try {
      ...
      // Utiliser folderId au lieu de parentId pour être cohérent avec le backend
      const folderId =
        currentPath.length > 1 ? currentPath[currentPath.length - 1] : null;
      ...
      const response = await API.post("/files-upload", formData, {
        ...
        // Augmenter le timeout si nécessaire pour les gros fichiers
        timeout: 30000,
      });
  ...
  if (!hierarchy) {
    return (
      <div className="container mx-auto p-4">Redirecting to sections...</div>
    );
  }
      ...
      <div className="p-6 flex">
        ...
        >
          ...
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex items-center space-x-2">
              <h1
                ...
                className="text-2xl cursor-pointer font-medium text-gray-500"
              >
                {t("myLibrary")}
              </h1>
              <Image
              ...
              {isSecondModalOpen && (
                ...
                >
                  ...
                  <div className="flex justify-end mt-4 space-x-2">
                    ...
                    {isCreatingFolder && (
                      <div className="fixed bottom-6 right-6 bg-white text-teal-600 shadow-lg rounded-lg px-6 py-3 flex items-center space-x-3 border border-gray-200 animate-fadeIn">
                        <svg
          ...
          <div className="mb-6 text-sm text-gray-500">
            <p>
              Total: {hierarchy.counts.totalFolders} folders,{" "}
              {hierarchy.counts.totalFiles} files
            </p>
          </div>
          ...
          <div
            className={`grid ${
              showChat ? "grid-cols-4" : "grid-cols-5"
