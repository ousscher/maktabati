          ...
          <div className="flex items-center space-x-4">
            ...
            {isFirstModalOpen && (
              <form onSubmit={handleSubmit}>
                <div
                  ref={secondModalRef}
                  className="absolute top-44 right-10  shadow-xl rounded-md p-6 w-72 border z-50"
                >
                    ...
                    onChange={(e) => {
                        ...
                        if (Form) {
                            ...
                            const isDuplicate = sections.some(
                              (section) => section.name.toLowerCase() === e.target.value.trim().toLowerCase()
                            );
              ...
              >
                ...
                <div className="ml-6">
                  ...
                  <p className="text-gray-500">
                    {section.folders ? section.folders : `XX ${t("folders")}`}
                  </p>
                </div>
              </div>
            ))}
