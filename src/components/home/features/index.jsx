        ...
        <section className="py-16 px-6 md:px-12 lg:px-20 text-center bg-transparent">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-y-8 mt-16">
                {features.map((feature, index) => (
                    <div key={index} className="flex items-center bg-white shadow-md rounded-full p-5 w-[500px] mx-auto border border-teal-600">
                        {/* Feature Icon */}
                        ...
                        <div className="text-left flex-1">
                            ...
                            <p className="text-sm text-gray-600">{t(`${feature.key}.description`)}</p>
                        </div>
                    </div>
                ))}
            </div>
